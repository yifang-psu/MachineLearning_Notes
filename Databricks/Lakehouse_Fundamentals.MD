...
- [x] Enforces access control lists on clusters, notebooks, tables and views. 
...
- [x] It is the storage format that data is put into that integrates with all data processing engines used within an organization
